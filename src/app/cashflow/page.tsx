...
export default function CashflowPage() {
  ...
  return (
    <div>
      <ScreenHeader title="Dòng tiền" subtitle="Thu và chi trong tháng" />
      <div className="mb-4">
        <PeriodPicker />
      </div>
        ...
        <div className="flex flex-col gap-6">
          <Card>
            ...
            <div className="grid grid-cols-2 gap-3 border-t border-border pt-3">
              ...
              <Stat label="Chi tiêu" value={<Money amount={financials.cashflow.expense} className="text-negative" />} hint={undefined} />
            </div>
