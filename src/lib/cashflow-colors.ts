/**
 * Money-in vs expense series colors for the Tổng quan thu chi charts, on the MSB
 * theme: Tiền vào uses the semantic positive green, Chi tiêu the MSB brand orange
 * (`--color-primary`). Kept in one place so the bars (Tổng quan) and the lines
 * (Biến động) stay identical.
 */

export const INCOME_COLOR = "#16a34a"; // Tiền vào — MSB positive green
